...
public class Calculator extends JFrame {
    ...
    public Calculator()
    {
       ...
       */
       ...
       /**
        * Criação das colunas/ linhas e do botão
        */
       ...
       //Aqui está definindo para que os números digitados não passem de 10
       ...
       textField2.addKeyListener(new KeyAdapter() {
         @Override 
         public void keyReleased(KeyEvent e) {
            if (textField2.getText().length() > tamanhoTextFieldsx) {
               String txtTextField2 = textField2.getText();
               textField2.setText(txtTextField2.substring(0,9));
               lblNotificacao.setText("<html><body>Ops! Este campo está limitado a apenas 9 caracteres</body></html</body></html>");
          ...
          if (textField1.getText().trim().length() == 0) {
            ...
            if (textField2.getText().trim().length() == 0) {
             ...
             //Aqui será feita a soma
               ...
               /**for: repetir até
                *textField: matriz de vetores aqui na soma
                *C: é a posição do textField
                *N: posição da variável numeros
                *c++ = some mais um numero, passa para o próximo
                *int c = 0; = variável, c < textfield...;= condição e c++ = contagem
                *substring: serva para fazer a leitura exata da posição na string
                *equals: comparador 
                */
